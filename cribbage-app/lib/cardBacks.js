...
const CARD_BACKS = [
  ...
  // ── Full-Card Scenes ──
  {
    ...
    bg: 'bg-amber-100',
    border: 'border-amber-400',
    bgHex: '#fef3c7', borderHex: '#fbbf24',
    pattern: 'linear-gradient(180deg, rgba(251,191,36,0.1) 0%, rgba(217,119,6,0.15) 100%)',
    centerIcon: '\uD83D\uDC1A',
  ...
  },
  {
    ...
    pattern: 'linear-gradient(180deg, rgba(202,138,4,0.08) 0%, transparent 100%)',
    centerIcon: '\uD83D\uDDBC\uFE0F',
  ...
  },
  {
    ...
    bgHex: '#fce7f3', borderHex: '#f472b6',
    pattern: 'linear-gradient(180deg, rgba(244,114,182,0.1) 0%, rgba(244,114,182,0.15) 100%)',
    centerIcon: '\uD83C\uDF38',
