...
const CARD_BACKS = [
  ...
  },
  {
    ...
    sceneImage: '/card-backs/american-gothic.webp',
  ...
  },
  {
    ...
    sceneImage: '/card-backs/the-scream.webp',
  ...
  },
  {
    ...
    iconColor: 'text-yellow-500',
    accentColor: 'rgba(161,98,7,0.2)',
    sceneImage: '/card-backs/mona-lisa.webp',
  ...
  // ── Paintings (image-based, borderless) ──
  {
    ...
    iconColor: 'text-amber-400',
    accentColor: 'rgba(245,158,11,0.2)',
    sceneImage: '/card-backs/lighthouse-painting-munch.webp',
    artistName: 'Edvard Munch',
  ...
  },
  {
    ...
    bgHex: '#fef3c7', borderHex: '#fde68a',
    pattern: 'none',
    centerIcon: '\uD83C\uDFD9\uFE0F',
    iconColor: 'text-sky-300',
    accentColor: 'rgba(56,189,248,0.2)',
    sceneImage: '/card-backs/skyscraper-paiting-okeeffe.webp',
  ...
  },
  {
    ...
    iconColor: 'text-yellow-300',
    accentColor: 'rgba(234,179,8,0.3)',
    sceneImage: '/card-backs/desert-painting-dali.webp',
  ...
  },
  {
    ...
    iconColor: 'text-green-700',
    accentColor: 'rgba(239,68,68,0.2)',
    sceneImage: '/card-backs/farm-painting-th-benton.webp',
  ...
  },
  {
    ...
    iconColor: 'text-yellow-300',
    accentColor: 'rgba(245,158,11,0.25)',
    sceneImage: '/card-backs/pyramids-painting-jl-gerome.webp',
  ...
  },
  {
    ...
    iconColor: 'text-stone-600',
    accentColor: 'rgba(120,113,108,0.2)',
    sceneImage: '/card-backs/castle-painting-t-kincade.webp',
  ...
  },
  {
    ...
    iconColor: 'text-orange-500',
    accentColor: 'rgba(251,146,60,0.3)',
    sceneImage: '/card-backs/sunrise-painting-shan-shui.webp',
  ...
  },
  {
    ...
    iconColor: 'text-cyan-600',
    accentColor: 'rgba(6,182,212,0.3)',
    sceneImage: '/card-backs/beach-painting-gauguin.webp',
  ...
  },
  {
    ...
    bgHex: '#1e1b4b', borderHex: '#d97706',
    pattern: 'none',
    centerIcon: '\u26FA',
    iconColor: 'text-amber-400',
    accentColor: 'rgba(217,119,6,0.3)',
    sceneImage: '/card-backs/camping-painting-1-van-gogh.webp',
    artistName: 'Vincent van Gogh',
    artistBio: 'Vincent van Gogh (1853\u20131890) was a Dutch Post-Impressionist painter whose bold colors and expressive brushwork profoundly influenced 20th-century art. "The Starry Night" (1889), painted from his asylum window in Saint-R\u00e9my-de-Provence, is one of the most recognized paintings in Western culture. Despite selling only one painting in his lifetime, van Gogh produced over 2,100 artworks in a decade of feverish creativity.',
  },
  {
    id: 'camping-bob-ross-1',
    type: 'painting',
    name: 'Lakeside Camp',
    bg: 'bg-emerald-950',
    border: 'border-amber-700',
    bgHex: '#022c22', borderHex: '#b45309',
    pattern: 'none',
    centerIcon: '\uD83C\uDFD5\uFE0F',
    iconColor: 'text-amber-400',
    accentColor: 'rgba(180,83,9,0.3)',
    sceneImage: '/card-backs/camping-painting-2-bob-ross.webp',
    artistName: 'Bob Ross',
    artistBio: 'Bob Ross (1942\u20131995) was an American painter and television host best known for "The Joy of Painting," which ran for 31 seasons on PBS. His calm demeanor, gentle voice, and "happy little trees" made painting accessible to millions. Ross\'s wet-on-wet oil technique allowed him to complete beautiful landscape paintings in under 30 minutes, inspiring a generation of hobby painters.',
  },
  {
    id: 'camping-bob-ross-2',
    type: 'painting',
    name: 'Fireside',
    bg: 'bg-orange-950',
    border: 'border-amber-700',
    bgHex: '#431407', borderHex: '#b45309',
    pattern: 'none',
    centerIcon: '\uD83D\uDD25',
    iconColor: 'text-orange-400',
    accentColor: 'rgba(251,146,60,0.3)',
    sceneImage: '/card-backs/camping-painting-3-bob-ross.webp',
    artistName: 'Bob Ross',
    artistBio: 'Bob Ross (1942\u20131995) was an American painter and television host best known for "The Joy of Painting," which ran for 31 seasons on PBS. His calm demeanor, gentle voice, and "happy little trees" made painting accessible to millions. Ross\'s wet-on-wet oil technique allowed him to complete beautiful landscape paintings in under 30 minutes, inspiring a generation of hobby painters.',
  },
  {
    ...
    bg: 'bg-stone-900',
    border: 'border-amber-700',
    bgHex: '#1c1917', borderHex: '#b45309',
    pattern: 'none',
    centerIcon: '\uD83D\uDC1A',
    iconColor: 'text-amber-300',
    accentColor: 'rgba(217,119,6,0.25)',
    sceneImage: '/card-backs/sea-shells-painting-balthasa-van-der-ast.webp',
    artistName: 'Balthasar van der Ast',
    artistBio: 'Balthasar van der Ast (1593\u20131657) was a Dutch Golden Age painter who specialized in still lifes of flowers, fruit, and shells. A pioneer of the shell still life genre, his meticulously detailed compositions elevated humble objects into art. Working in Utrecht and Delft, van der Ast was among the first European painters to depict exotic shells brought back by Dutch trading ships, combining scientific precision with luminous beauty.',
  },
  {
    id: 'volcano-hokusai',
    type: 'painting',
    ...
    bg: 'bg-red-950',
    border: 'border-amber-600',
    bgHex: '#450a0a', borderHex: '#d97706',
    pattern: 'none',
    centerIcon: '\uD83C\uDF0B',
    iconColor: 'text-red-400',
    accentColor: 'rgba(239,68,68,0.3)',
    sceneImage: '/card-backs/volcano-painting-hokusai.webp',
    artistName: 'Katsushika Hokusai',
    artistBio: 'Katsushika Hokusai (1760\u20131849) was a Japanese ukiyo-e artist whose woodblock prints profoundly influenced Western Impressionism. His series "Thirty-Six Views of Mount Fuji," including the iconic "The Great Wave off Kanagawa," remains among the most celebrated works in all of art history. Hokusai produced over 30,000 works across seven decades, famously claiming that everything he drew before age 70 was "not worth counting."',
  },
  {
    id: 'tractor-benton',
    type: 'painting',
    ...
    centerIcon: '\uD83D\uDE9C',
    iconColor: 'text-yellow-500',
    accentColor: 'rgba(161,98,7,0.25)',
    sceneImage: '/card-backs/tractor-painting-th-benton.webp',
    artistName: 'Thomas Hart Benton',
    artistBio: 'Thomas Hart Benton (1889\u20131975) was an American painter and muralist, a leader of the Regionalism art movement. His dynamic, rolling compositions depicted everyday life in the American heartland\u2014farmers, laborers, and small-town scenes rendered with muscular, rhythmic forms. He was a mentor to the young Jackson Pollock.',
  },
];
