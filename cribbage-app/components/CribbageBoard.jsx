 ...
 */
export default function CribbageBoard({ playerScore, computerScore, playerLabel = 'You', opponentLabel = 'CPU', initialPlayerBackPeg, initialComputerBackPeg, onBackPegChange }) {
